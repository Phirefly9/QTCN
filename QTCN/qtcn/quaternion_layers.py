...
from   QTCN.qtcn.quaternion_ops import *
import math
import sys
...
class QuaternionConv(Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size, stride,
                 ...
                 weight_init='quaternion', seed=None, operation='convolution1d', rotation=False, 
                 quaternion_format=True, scale=False, dropconnect=0):
